...
import MontarCasinha from "@/components/bolao/MontarCasinha";
import ResultadoFinal from "@/components/bolao/ResultadoFinal";
import ProgressoPiloti from "@/components/bolao/ProgressoPiloti";
import RegrasCampanha from "@/components/bolao/RegrasCampanha";
import CompartilharCampanha from "@/components/bolao/CompartilharCampanha";
import RastreioHome from "@/components/bolao/RastreioHome";
import LogoTeto from "@/components/bolao/LogoTeto";
import { IconRelogio } from "@/components/bolao/icones";
    ...
    <main className="canvas">
      ...
      <footer className="rodape">
        ...
        <div className="rodape-links">
          <a href="/bolaodacopa/privacidade">Aviso de Privacidade</a>
        </div>
      </footer>
    </main>
  );
