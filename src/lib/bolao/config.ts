...
// Resultado da final e vencedor do sorteio. Ficam aqui pra a página e a arte
// de divulgação lerem a mesma fonte e nunca divergirem.
export const PLACAR_FINAL = { casa: 1, visitante: 0 };
export const VENCEDOR_SORTEIO = "Thiago Gonsalves Segunda";
