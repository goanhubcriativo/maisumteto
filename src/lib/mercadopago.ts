// Cliente da API do Mercado Pago para gerar cobranças PIX.
// Docs: https://www.mercadopago.com.br/developers/pt/reference/payments/_payments/post
//
// Serve a plataforma e o bolão: é uma conta MP só, um token só, e o controle de
// onde veio cada real fica no nosso banco, não na conta bancária.
//
// UMA chamada a POST /v1/payments já devolve o pagamento COM o QR e o
// copia-e-cola embutidos: não precisa criar "customer" nem buscar o QR depois.
