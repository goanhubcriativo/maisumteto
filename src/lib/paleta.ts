...
export const PALETA: CorDaPaleta[] = [
  ...
  // As cores ampliadas. Nas claras (verde, dourado, azul céu), o `forte` é um
  // tom escuro só pra texto passar em 4.5:1, e a `marca` é a cor viva (mancha),
  // aprofundada só o bastante pra chegar em 3:1. Nas escuras, forte e marca são
  // a mesma cor. Ver testes/paleta.js.
  {
    id: "verde",
    nome: "Verde",
    forte: "#448346",
    marca: "#56a457",
    fundo: "rgba(86, 164, 87, 0.08)",
    borda: "rgba(86, 164, 87, 0.2)",
  },
  {
    id: "dourado",
    nome: "Dourado",
    forte: "#89743d",
    marca: "#ab904c",
    fundo: "rgba(171, 144, 76, 0.1)",
    borda: "rgba(171, 144, 76, 0.24)",
  },
  {
    id: "magenta",
    nome: "Magenta",
    forte: "#c04799",
    marca: "#cc4ba3",
    fundo: "rgba(204, 75, 163, 0.07)",
    borda: "rgba(204, 75, 163, 0.18)",
  },
  {
    id: "anil",
    nome: "Anil",
    forte: "#283568",
    fundo: "rgba(40, 53, 104, 0.07)",
    borda: "rgba(40, 53, 104, 0.16)",
  },
  {
    id: "violeta",
    nome: "Violeta",
    forte: "#7f3fe0",
    fundo: "rgba(127, 63, 224, 0.07)",
    borda: "rgba(127, 63, 224, 0.18)",
  },
  {
    id: "vermelho",
    nome: "Vermelho",
    forte: "#c33531",
    fundo: "rgba(195, 53, 49, 0.07)",
    borda: "rgba(195, 53, 49, 0.18)",
  },
  {
    id: "laranja",
    nome: "Laranja",
    forte: "#b75b37",
    marca: "#d0673f",
    fundo: "rgba(208, 103, 63, 0.08)",
    borda: "rgba(208, 103, 63, 0.18)",
  },
  {
    id: "ceu",
    nome: "Azul céu",
    forte: "#437995",
    marca: "#569abf",
    fundo: "rgba(86, 154, 191, 0.08)",
    borda: "rgba(86, 154, 191, 0.18)",
  },
  {
    id: "grafite",
    nome: "Grafite",
